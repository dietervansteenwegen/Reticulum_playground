...
def server_loop(destination):
    ...
    RNS.log("Link example " + RNS.prettyhexrep(destination.hash) +
    ...
    try:
        ...
        if len(destination_hexhash) != dest_len:
            raise ValueError(
                ...
                .format(hex=dest_len, byte=dest_len // 2))
        ...
        try:
            ...
            if text != "":
                ...
                if len(data) <= RNS.Link.MDU:
                    ...
                    RNS.log(
                        "Cannot send this packet, the data size of " + str(len(data)) +
                        " bytes exceeds the link packet MDU of " + str(RNS.Link.MDU) + " bytes",
                        RNS.LOG_ERROR)
